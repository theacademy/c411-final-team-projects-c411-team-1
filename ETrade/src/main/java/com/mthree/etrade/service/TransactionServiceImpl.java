...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction executeSellTransaction(Long portfolioId, String stockSymbol, int quantity, BigDecimal price) {
        ...
        Optional<StockPortfolio> optionalStockPortfolio = stockPortfolioDAO.findByPortfolioIdAndStockSymbol(portfolioId, stockSymbol);
    ...
    private void updateStockPortfolioForBuy(Portfolio portfolio, Stock stock, int quantity, BigDecimal price) {
        Optional<StockPortfolio> optionalStockPortfolio = stockPortfolioDAO.findByPortfolioIdAndStockSymbol(portfolio.getPortfolioId(), stock.getSymbol());
    ...
    private void updatePortfolioTotalValue(Portfolio portfolio) {
        ...
        List<StockPortfolio> stockPortfolios = stockPortfolioDAO.findByPortfolioId(portfolio.getPortfolioId());
